...
const teamMembers = [
    ...
    { name: 'Jacob Klymenko', img: jacobKlymenko, description: 'As the Backend Lead of the Tech Startup Club, I focus on database management and API development, mentoring team members while delivering reliable and scalable backend solutions.' },
